    ...
    if request.POST:
        ...
        try:
            ...
            if var.c_pass == pass1:
                ...
                return HttpResponse("<h1> <a href=""> You Have Entered Wrong Password </h1>")    


        except:
            return HttpResponse("<h1> <a href=""> Email Id Is Not Registered User </h1>")
...
def CompForgetPass(request):
    if request.POST:
        ...
        try:
            ...
            sender_email = "flashlightningspeed17@gmail.com"
            sender_pass = '12121010'
            reciv_email = em1      
...
def CompDashBoard(request):
    if 'com_data' in request.session.keys():
        ...
        return render(request,'company/dash/dash.html',{'USERS':comp})
    else:
       return redirect('c_login') 
